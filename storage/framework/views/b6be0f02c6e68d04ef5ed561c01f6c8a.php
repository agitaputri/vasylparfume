    ...
    <div class="container p-0  mb-4 mt-4 rounded-3 shadow bg-white">
        ...
        <div id="tentang" class="px=4 py-4 bg-secondary text-center">
            <div class="mx-auto w-75">
                ...
                <p class="text-center text-white"><img src="<?php echo e(asset('assets/about-us.jpeg')); ?>" align="left"
        ...
        <div id="order" class="px=4 py-4 bg-light text-center">
            <div class="mx-auto w-75">
                ...
                <p class="text-center text-black"><img src="<?php echo e(asset('assets/order.png')); ?>" align="right"
...
<?php /**PATH /Users/bintangtobing/Desktop/GitHub/intern-unpri/vasylparfume/resources/views/welcome.blade.php ENDPATH**/ ?>