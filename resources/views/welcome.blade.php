        ...
        <div class="row row-cols-md-3 row-cols-2 gx-5 p-5">
            ...
            <div id="order" class="px=4 py-4 bg-light text-center">
              <div class="mx-auto w-75">
                ...
                <p class="text-center text-black"><img src="{{asset('assets/order.png')}}" align="right" style="width: 100px;height:auto" class="ms-3 mb-3"/> Parfume kami bisa di order langsung dengan klik detail dan beli produk ini. Atau dengan menghubungi kami di Instagram :@vasylparfume dan whatsapp: 0882015043348.</p>
              </div>
            </div>
